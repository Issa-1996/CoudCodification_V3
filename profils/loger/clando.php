                ...
                <ul class="options">
                    ...
                    ?>
                            ...
                            ?>
                                <div class="row" style="display: flex;justify-content: center;color:black;">
                                    <div class="col-md-4 mb-3">
                                        <a class="btn btn-secondary" href="/COUD/codif/profils/loger/clando.php" type="button">RETOUR</a>
                                    </div>
                                </div>
                            <?php
                            } else {
                                ...
                                ?>
                                    <div class="row" style="display: flex;justify-content: center;color:black;">
                                        <?php if (isset($data['id_paie'])) { ?>
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" placeholder="NUMERO CARTE ETUDIANT" name="num_etu" id="num_etu">
                                                <script>
