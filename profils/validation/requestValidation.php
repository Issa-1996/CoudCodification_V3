                    ...
                    if (mysqli_num_rows($dataValiteTitulaire) > 0) {
                        ...
                        if (mysqli_num_rows($dataSuppleantIfChoiseLit) > 0) {
                            ...
                            if ($arrayTitulaire['id_lit']) {
                                ...
                                $queryString2 = http_build_query(['data_titulaire' => $arrayTitulaire]);
                                header("location: validation.php?statut=suppleant&idLit=" . $idLitTitulaireOnSuppleant . '&' . $queryString.'&'.$queryString2);
                                exit();
                            }
                        }
                    } else {
