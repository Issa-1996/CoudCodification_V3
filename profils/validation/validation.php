    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="options">
                    <?php
                    if (isset($_GET['data']) || isset($_GET['data_titulaire'])) {
                        $data = $_GET['data'];
                        if (isset($_GET['data_titulaire'])) {
                            $data2 = $_GET['data_titulaire'];
                        }
                            ...
                            <form action="requestValidation.php" method="POST">
                                ...
                                ?>
                                    <div class="row" style="display: flex;justify-content: center;color:black;">
                                        ...
                                        <div class="col-md-4    ">
                                            <input class="form-control" placeholder="Campus : <?= $data2['campus'] ?>" disabled>
                                        </div>
                                    </div><br>
                                    <div class="row" style="display: flex;justify-content: center;color:black;">
                                        <div class="col-md-4     mb-3">
                                            <input class="form-control" placeholder="Pavillon : <?= $data2['pavillon'] ?>" disabled>
                                        </div>
                                        <div class="col-md-4    ">
                                            <input class="form-control" placeholder="Lit : <?= $data2['lit'] ?>" disabled>
                                        </div>
                                    </div>
